...
class DynamicSettings(models.Model):
    ...
    field_type = models.IntegerField(_(u'Тип данных'), editable=False,
        choices=(
...
class UserProfile(models.Model):
    ...
    last_name_accusative = models.CharField(_(u'Фамилия (вин.)'), max_length=ModelConstants.MAX_NAME_LENGTH, blank=True, null=True)
    middle_name_accusative = models.CharField(_(u'Отчество (вин.)'), max_length=ModelConstants.MAX_NAME_LENGTH, blank=True, null=True)
...
class Document(models.Model):
    ...
    prolongation = models.BooleanField(_(u'Возможность рролонгации'), blank=True, default=False)
...
class Request(models.Model):
    ...
    accepted = models.DateField(_(u'Дата согласования'), blank=True, default=False)
    ...
    document = models.OneToOneField(Document, verbose_name=_(u'Документ'), related_name='document')
