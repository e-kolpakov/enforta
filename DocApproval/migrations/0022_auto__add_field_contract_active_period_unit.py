...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Contract.active_period_unit'
        db.add_column(u'DocApproval_contract', 'active_period_unit',
                      self.gf('django.db.models.fields.CharField')(default='d', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.active_period_unit'
        db.delete_column(u'DocApproval_contract', 'active_period_unit')
    ...
    models = {
        ...
        'DocApproval.contract': {
            ...
            'active_period_unit': ('django.db.models.fields.CharField', [], {'default': "'d'", 'max_length': '50'}),
