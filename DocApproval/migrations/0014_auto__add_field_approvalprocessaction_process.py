...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApprovalProcessAction.process'
        db.add_column(u'DocApproval_approvalprocessaction', 'process',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['DocApproval.ApprovalProcess']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApprovalProcessAction.process'
        db.delete_column(u'DocApproval_approvalprocessaction', 'process_id')
    ...
    models = {
        ...
        u'DocApproval.approvalprocessaction': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'process': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['DocApproval.ApprovalProcess']"}),
