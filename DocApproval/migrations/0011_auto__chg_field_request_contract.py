...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Request.contract'
        db.alter_column(u'DocApproval_request', 'contract_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, unique=True, to=orm['DocApproval.Contract']))

    def backwards(self, orm):

        # Changing field 'Request.contract'
        db.alter_column(u'DocApproval_request', 'contract_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['DocApproval.Contract']))
