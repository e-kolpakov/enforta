...
class Migration(SchemaMigration):
    def forwards(self, orm):
        db.rename_column(u'DocApproval_city', 'city_name', 'name')
        db.rename_column(u'DocApproval_requeststatus', 'status_name', 'name')

    def backwards(self, orm):
        db.rename_column(u'DocApproval_city', 'name', 'city_name')
        db.rename_column(u'DocApproval_requeststatus', 'name', 'status_name')
