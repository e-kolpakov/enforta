...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'ApprovalProcessAction.comment'
        db.add_column(u'DocApproval_approvalprocessaction', 'comment',
                      self.gf('django.db.models.fields.CharField')(max_length=4000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApprovalProcessAction.comment'
        db.delete_column(u'DocApproval_approvalprocessaction', 'comment')
