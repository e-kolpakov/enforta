...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.activation_date'
        db.add_column(u'DocApproval_contract', 'activation_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Contract.paid_date'
        db.alter_column(u'DocApproval_contract', 'paid_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Contract.activation_date'
        db.delete_column(u'DocApproval_contract', 'activation_date')


        # User chose to not deal with backwards NULL issues for 'Contract.paid_date'
        raise RuntimeError("Cannot reverse this migration. 'Contract.paid_date' and its values cannot be restored.")
    ...
    models = {
        ...
        u'DocApproval.request': {
            ...
            'contract': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'request'", 'unique': 'True', 'null': 'True', 'to': u"orm['DocApproval.Contract']"}),
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
