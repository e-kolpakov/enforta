...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.approval_route'
        db.add_column(u'DocApproval_request', 'approval_route',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['DocApproval.ApprovalRoute'], unique=True, null=True),
                      keep_default=False)

        # Deleting field 'ApprovalRoute.request'
        db.delete_column(u'DocApproval_approvalroute', 'request_id')


    def backwards(self, orm):
        # Deleting field 'Request.approval_route'
        db.delete_column(u'DocApproval_request', 'approval_route_id')

        # Adding field 'ApprovalRoute.request'
        db.add_column(u'DocApproval_approvalroute', 'request',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='approval_route', unique=True, null=True, to=orm['DocApproval.Request']),
                      keep_default=False)
