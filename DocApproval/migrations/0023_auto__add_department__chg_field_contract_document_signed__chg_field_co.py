...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'DocApproval_department', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=4000)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DocApproval.City'])),
            ('show_in_list', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('responsible_user',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DocApproval.UserProfile'], null=True,
                                                                   blank=True)),
        ))
        db.send_create_signal('DocApproval', ['Department'])


        # Changing field 'Contract.document_signed'
        db.alter_column(u'DocApproval_contract', 'document_signed',
                        self.gf('DocApproval.utilities.file_upload.ContentTypeRestrictedFileField')(max_length=100,
                                                                                                    null=True))

        # Changing field 'Contract.document'
        db.alter_column(u'DocApproval_contract', 'document',
                        self.gf('DocApproval.utilities.file_upload.ContentTypeRestrictedFileField')(max_length=100))

    def backwards(self, orm):
        # Deleting model 'Department'
        db.delete_table(u'DocApproval_department')
