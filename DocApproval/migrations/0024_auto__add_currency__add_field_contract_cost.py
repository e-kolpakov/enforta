...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'DocApproval_currency', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('caption', self.gf('django.db.models.fields.CharField')(max_length=800)),
            ('caption_plural', self.gf('django.db.models.fields.CharField')(max_length=800)),
            ('short_caption', self.gf('django.db.models.fields.CharField')(max_length=800)),
            ('symbol', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('DocApproval', ['Currency'])

        # Adding field 'Contract.cost'
        db.add_column(u'DocApproval_contract', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Currency'
        db.delete_table(u'DocApproval_currency')

        # Deleting field 'Contract.cost'
        db.delete_column(u'DocApproval_contract', 'cost')
