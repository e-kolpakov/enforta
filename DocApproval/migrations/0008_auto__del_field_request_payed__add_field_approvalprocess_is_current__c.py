...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApprovalProcess.is_current'
        db.add_column(u'DocApproval_approvalprocess', 'is_current',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ApprovalRoute.request'
        db.alter_column(u'DocApproval_approvalroute', 'request_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['DocApproval.Request']))
        # Adding unique constraint on 'ApprovalRoute', fields ['request']
        db.create_unique(u'DocApproval_approvalroute', ['request_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ApprovalRoute', fields ['request']
        db.delete_unique(u'DocApproval_approvalroute', ['request_id'])
        ...
        # Deleting field 'ApprovalProcess.is_current'
        db.delete_column(u'DocApproval_approvalprocess', 'is_current')


        # Changing field 'ApprovalRoute.request'
        db.alter_column(u'DocApproval_approvalroute', 'request_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['DocApproval.Request']))
    ...
    models = {
        ...
        u'DocApproval.approvalroute': {
            ...
            'request': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'approval_route'", 'unique': 'True', 'null': 'True', 'to': u"orm['DocApproval.Request']"})
        },
