...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'ApprovalProcess.total_steps'
        db.add_column(u'DocApproval_approvalprocess', 'total_steps',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApprovalProcess.total_steps'
        db.delete_column(u'DocApproval_approvalprocess', 'total_steps')
    ...
    models = {
        'DocApproval.approvalprocess': {
            ...
            'total_steps': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
