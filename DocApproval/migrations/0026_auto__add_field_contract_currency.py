...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Contract.currency'
        db.add_column(u'DocApproval_contract', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DocApproval.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.currency'
        db.delete_column(u'DocApproval_contract', 'currency_id')
