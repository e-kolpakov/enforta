...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Request.last_updater'
        db.alter_column(u'DocApproval_request', 'last_updater_id',
    ...
    def backwards(self, orm):
        # Changing field 'Request.last_updater'
        db.alter_column(u'DocApproval_request', 'last_updater_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True,
                                                                              to=orm['DocApproval.UserProfile']))
    ...
    models = {
        ...
        u'DocApproval.request': {
            ...
            'last_updater': ('django.db.models.fields.related.ForeignKey', [],
                             {'related_name': "'last_updated_by'", 'to': u"orm['DocApproval.UserProfile']"}),
