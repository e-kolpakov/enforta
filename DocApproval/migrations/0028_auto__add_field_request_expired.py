...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.expired'
        db.add_column(u'DocApproval_request', 'expired',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.expired'
        db.delete_column(u'DocApproval_request', 'expired')
    ...
    models = {
        'DocApproval.approvalprocess': {
            ...
            'route': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'processes'", 'to': "orm['DocApproval.ApprovalRoute']"})
        },
        'DocApproval.approvalprocessaction': {
            ...
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '4000', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'process': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'actions'", 'to': "orm['DocApproval.ApprovalProcess']"}),
        ...
        'DocApproval.approvalroutestep': {
            ...
            'approver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'approval_steps'", 'null': 'True', 'to': "orm['DocApproval.UserProfile']"}),
            'calc_step': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'route': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'steps'", 'to': "orm['DocApproval.ApprovalRoute']"}),
        ...
        'DocApproval.contract': {
            ...
            'document_signed': ('DocApproval.utilities.file_upload.ContentTypeRestrictedFileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'DocApproval.department': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '4000'}),
            'responsible_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DocApproval.UserProfile']", 'null': 'True', 'blank': 'True'}),
        ...
        'DocApproval.departmentcityoverride': {
            ...
            'department': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'city_overrides'", 'to': "orm['DocApproval.Department']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'responsible_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DocApproval.UserProfile']", 'null': 'True', 'blank': 'True'}),
            'show_in_list': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        ...
        'DocApproval.request': {
            ...
            'approval_route': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['DocApproval.ApprovalRoute']", 'unique': 'True', 'null': 'True'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DocApproval.City']"}),
            'comments': ('django.db.models.fields.CharField', [], {'max_length': '4000', 'null': 'True', 'blank': 'True'}),
            'contract': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'request'", 'unique': 'True', 'to': "orm['DocApproval.Contract']"}),
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'requests'", 'to': "orm['DocApproval.UserProfile']"}),
            'expired': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updater': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'requests_last_updated_by'", 'to': "orm['DocApproval.UserProfile']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'send_on_approval': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'requests_to_be_sent_on_approval'", 'to': "orm['DocApproval.UserProfile']"}),
        ...
        'DocApproval.requesthistory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'request': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'history'", 'to': "orm['DocApproval.Request']"})
        },
        ...
        'DocApproval.temporaryuserimpersonation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'replacing'", 'to': "orm['DocApproval.UserProfile']"}),
            'replaced_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'replaced_by'", 'to': "orm['DocApproval.UserProfile']"}),
        ...
        'DocApproval.userprofile': {
            ...
            'manager': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DocApproval.UserProfile']", 'null': 'True', 'blank': 'True'}),
