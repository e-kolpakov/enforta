...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApprovalRouteStep.calc_step'
        db.add_column(u'DocApproval_approvalroutestep', 'calc_step',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ApprovalRouteStep.approver'
        db.alter_column(u'DocApproval_approvalroutestep', 'approver_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DocApproval.UserProfile'], null=True))

    def backwards(self, orm):
        # Deleting field 'ApprovalRouteStep.calc_step'
        db.delete_column(u'DocApproval_approvalroutestep', 'calc_step')


        # Changing field 'ApprovalRouteStep.approver'
        db.alter_column(u'DocApproval_approvalroutestep', 'approver_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['DocApproval.UserProfile']))
