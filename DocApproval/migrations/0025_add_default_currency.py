...
class Migration(DataMigration):
    def forwards(self, orm):
        orm.Currency.objects.create(caption=u"Рубль", caption_plural=u"Рубли", short_caption=u"руб.", symbol=u"руб.")
        orm.Currency.objects.create(caption=u"Доллар", caption_plural=u"Доллары", short_caption=u"USD", symbol=u"$")
