...
class RequestActionRepository(Mapping):
    ...
    _actions = {
        SendToApprovalAction.code: SendToApprovalAction(_(u"Отправить на утверждение"), icon="icons/to_approval.png")
    }

    __getitem__ = _actions.get
    __iter__ = _actions.iteritems
