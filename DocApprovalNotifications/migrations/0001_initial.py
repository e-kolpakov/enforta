...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'Event'
        db.create_table(u'DocApprovalNotifications_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('entity', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.send_create_signal(u'DocApprovalNotifications', ['Event'])

        # Adding model 'Notification'
        db.create_table(u'DocApprovalNotifications_notification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DocApprovalNotifications.Event'])),
            ('notification_recipient',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DocApproval.UserProfile'], null=True)),
            ('repeating', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('times_shown_in_ui', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'DocApprovalNotifications', ['Notification'])


    def backwards(self, orm):
        # Deleting model 'Event'
        db.delete_table(u'DocApprovalNotifications_event')

        # Deleting model 'Notification'
        db.delete_table(u'DocApprovalNotifications_notification')
    ...
    models = {
        ...
        u'DocApprovalNotifications.event': {
            ...
            'sender': (
                ...
                {'to': "orm['DocApproval.UserProfile']", 'null': 'True'}),
        ...
        u'DocApprovalNotifications.notification': {
            ...
            'times_shown_in_ui': ('django.db.models.fields.IntegerField', [], {})
        },
        u'auth.group': {
