...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.most_recent_sent'
        db.add_column(u'DocApprovalNotifications_notification', 'most_recent_sent',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.most_recent_sent'
        db.delete_column(u'DocApprovalNotifications_notification', 'most_recent_sent')
    ...
    models = {
        ...
        u'DocApprovalNotifications.notification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'most_recent_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
