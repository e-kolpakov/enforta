...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'Notification.repeating'
        db.delete_column(u'DocApprovalNotifications_notification', 'repeating')

        # Adding field 'Notification.recurring'
        db.add_column(u'DocApprovalNotifications_notification', 'recurring',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Notification.repeating'
        db.add_column(u'DocApprovalNotifications_notification', 'repeating',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Notification.recurring'
        db.delete_column(u'DocApprovalNotifications_notification', 'recurring')
