...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notification.email_sent'
        db.add_column(u'DocApprovalNotifications_notification', 'email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Notification.shown_in_ui'
        db.add_column(u'DocApprovalNotifications_notification', 'shown_in_ui',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Notification.email_sent'
        db.delete_column(u'DocApprovalNotifications_notification', 'email_sent')

        # Deleting field 'Notification.shown_in_ui'
        db.delete_column(u'DocApprovalNotifications_notification', 'shown_in_ui')
    ...
    models = {
        ...
        u'DocApprovalNotifications.event': {
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DocApproval.UserProfile']", 'null': 'True'}),
        ...
        u'DocApprovalNotifications.notification': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['DocApprovalNotifications.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'notification_recipient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['DocApproval.UserProfile']", 'null': 'True'}),
            ...
            'shown_in_ui': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'auth.group': {
